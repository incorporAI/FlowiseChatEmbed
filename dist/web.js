...
function a(s, n) {
    ...
    return class extends s {
        ...
        attributeChangedCallback(t, r, s) {
            !this.__initialized || this.__updating[t] || (t = this.lookupProp(t))in n && (null == s && !this[t] || (this[t] = n[t].parse ? e(s) : s))
        }
        lookupProp(t) {
            if (n)
                return o.find((e=>t === e || t === n[e].attribute))
        }
        get renderRoot() {
...
function l(t, e={}, r={}) {
    ...
    return r=>{
        ...
        return i ? i.prototype.Component = r : ((i = a(n, function(t) {
...
function A(t, e, r) {
    return r = r ? Object.assign({}, u, r) : u,
...
function P(t) {
    return null !== b && (null === b.cleanups ? b.cleanups = [t] : b.cleanups.push(t)),
        t
}
function $() {
    var t;
    return this.sources && this.state && (this.state === d ? T(this) : (t = v,
        v = null,
        j((()=>I(this)), !1),
        v = t)),
    m && (t = this.observers ? this.observers.length : 0,
...
function R(t, e, r) {
    ...
    t.observers && t.observers.length && j((()=>{
            for (let s = 0; s < t.observers.length; s += 1) {
                var e = t.observers[s]
                    , r = y && y.running;
                r && y.disposed.has(e),
                (r ? e.tState : e.state) || ((e.pure ? v : w).push(e),
                e.observers && M(e)),
                r || (e.state = d)
            }
            if (1e6 < v.length)
    ...
    t.fn && (q(t),
        ...
        function(t, e, r) {
            ...
            try {
                ...
                return t.pure && (t.state = d,
                t.owned && t.owned.forEach(q),
                    t.owned = null),
                    t.updatedAt = r + 1,
                    D(e)
            }
            (!t.updatedAt || t.updatedAt <= r) && (null != t.updatedAt && "observers"in t ? R(t, s) : t.value = s,
                t.updatedAt = r)
        }(m = b = t, t.value, s),
        m = r,
        b = e)
...
function L(t) {
    if (0 !== t.state) {
        ...
        for (let s = r.length - 1; 0 <= s; s--) {
            var e;
            (t = r[s]).state === d ? T(t) : t.state === f && (e = v,
                v = null,
                j((()=>I(t, r[0])), !1),
                v = e)
        }
...
function I(t, e) {
    for (let n = t.state = 0; n < t.sources.length; n += 1) {
        var r, s = t.sources[n];
        s.sources && ((r = s.state) === d ? s !== e && (!s.updatedAt || s.updatedAt < x) && L(s) : r === f && I(s, e))
    }
}
function M(t) {
    ...
    return A(function(t, e, r={}) {
        ...
        return P((()=>G(o))),
            ()=>{
                ...
                return u[h],
                    E((()=>{
                            let t, e, h, d, f, g, b, y, m, v = u.length;
                            if (0 === v)
                                0 !== i && (G(o),
                                    o = [],
                                    s = [],
...
function J(t) {
    ...
    return A((()=>{
            ...
            if (s) {
                const n = t.children;
                return "function" == typeof n && 0 < n.length ? E((()=>n(e ? s : ()=>{
                        if (E(r))
                            return t.when;
...
const rt = new Set(["beforeinput", "click", "dblclick", "contextmenu", "focusin", "focusout", "input", "keydown", "keyup", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "pointerdown", "pointermove", "pointerout", "pointerover", "pointerup", "touchend", "touchmove", "touchstart"])
    , st = {
...
function ot(t, e, r) {
    ...
    ;
    return (e = e ? ()=>(s = s || n()).cloneNode(!0) : ()=>E((()=>document.importNode(s = s || n(), !0)))).cloneNode = e
}
...
function ct(t, e={}, r, s) {
    const n = {};
    return s || C((()=>n.children = gt(t, e.children, n.children))),
        C((()=>e.ref && e.ref(t))),
        C((()=>function(t, e, r, s, n={}, o=!1) {
            e = e || {};
            for (const s in n)
                s in e || "children" !== s && (n[s] = dt(t, s, null, n[s], r, o));
            for (const a in e) {
                var i;
                "children" === a ? s || gt(t, e.children) : (i = e[a],
                    n[a] = dt(t, a, i, n[a], r, o))
            }
        }(t, e, r, !0, n, !0))),
        n
}
...
function dt(t, e, r, s, n, o) {
    ...
    return "style" === e ? function(t, e, r) {
        ...
        for (o = 0,
            ...
            var l = s[o]
                , c = !!e[l];
            l && "undefined" !== l && r[l] !== c && c && (pt(t, l, !0),
                r[l] = c)
        }
        return r
    ...
    !(u = rt.has(o)) && s && (s = Array.isArray(s) ? s[0] : s,
    ...
    (u || r) && (function(t, e, r, s) {
        ...
        u) && it([o])) : "attr:" === e.slice(0, 5) ? at(t, e.slice(5), r) : (h = "prop:" === e.slice(0, 5)) || (l = Z.has(e)) || !n && ((c = function(t, e) {
        return "object" == typeof (t = et[t]) ? t[e] ? t.$ : void 0 : t
    }(e, t.tagName)) || (a = Q.has(e))) || (i = t.nodeName.includes("-")) ? (h && (e = e.slice(5),
        a = !0),
        "class" === e || "className" === e ? lt(t, r) : !i || a || l ? t[c || e] = r : t[function(t) {
            return t.toLowerCase().replace(/-([a-z])/g, ((t,e)=>e.toUpperCase()))
        }(e)] = r) : (s = n && -1 < e.indexOf(":") && st[e.split(":")[0]]) ? function(t, e, r, s) {
        null == s ? t.removeAttributeNS(e, r) : t.setAttributeNS(e, r, s)
    }(t, s, e, r) : at(t, tt[e] || e, r),
        r)
}
function ft(t) {
    var e = "$$" + t.type;
        ...
        "string" == o || "number" == o)
            ...
            if (Array.isArray(e)) {
                ...
                if (0 === a.length) {
                    ...
                    o ? 0 === r.length ? yt(t, a, s) : function(t, e, r) {
                        let s = r.length
                            , n = e.length
                            , o = s
                            , i = 0
            ...
            if (Array.isArray(a))
                ...
                if (s) {
                    for (; "function" == typeof a; )
                        a = a();
                    n = bt(t, Array.isArray(a) ? a : [a], Array.isArray(l) ? l : [l]) || n
                } else
                    t.push(a),
                        n = !0;
            else {
...
const St = t=>null == t
    ...
    , Et = async t=>{
        try {
            var e = "string" == typeof t ? t : t.url
                ...
                mode: "cors",
                headers: "string" != typeof t && At(t.body) ? {
                    "Content-Type": "application/json"
                } : void 0,
                body: "string" != typeof t && At(t.body) ? JSON.stringify(t.body) : void 0
            })
                , s = await r.json();
            if (r.ok)
                return {
    ...
    , Ot = ot('<svg viewBox="0 0 24 24"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z">')
    , Pt = ot('<img alt="Bubble button icon">')
    , $t = ot('<button part="button"><svg viewBox="0 0 24 24"><path fill-rule="evenodd" clip-rule="evenodd" d="M18.601 8.39897C18.269 8.06702 17.7309 8.06702 17.3989 8.39897L12 13.7979L6.60099 8.39897C6.26904 8.06702 5.73086 8.06702 5.39891 8.39897C5.06696 8.73091 5.06696 9.2691 5.39891 9.60105L11.3989 15.601C11.7309 15.933 12.269 15.933 12.601 15.601L18.601 9.60105C18.9329 9.2691 18.9329 8.73091 18.601 8.39897Z">')
    , Rt = t=>{
        {
            const e = $t()
                , r = e.firstChild;
                ...
                ut(e, H(J, {
                    ...
                    get children() {
                        ...
                        return C((r=>{
                                ...
                                return s !== r._v$3 && at(e, "src", r._v$3 = s),
    ...
    , Tt = (it(["click"]),
        ({chatflowid: t, apiHost: e="http://localhost:3000", body: r})=>Et({
            method: "POST",
            url: e + "/api/v1/prediction/" + t,
            body: r
        }))
    , Bt = ot('<input class="focus:outline-none bg-transparent px-4 py-4 flex-1 w-full text-input" type="text">')
    , Lt = t=>{
        const [e,r] = X(t, ["ref", "onInput"]);
        return (s = Bt()).$$input = t=>e.onInput(t.currentTarget.value),
    ...
    , jt = (it(["input"]),
        ot('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="19px"><path d="M476.59 227.05l-.16-.07L49.35 49.84A23.56 23.56 0 0027.14 52 24.65 24.65 0 0016 72.59v113.29a24 24 0 0019.52 23.57l232.93 43.07a4 4 0 010 7.86L35.53 303.45A24 24 0 0016 327v113.31A23.57 23.57 0 0026.59 460a23.94 23.94 0 0013.22 4 24.55 24.55 0 009.52-1.93L476.4 285.94l.19-.09a32 32 0 000-58.8z">'))
    , Nt = t=>{
        return ct(e = jt(), Y({
            get style() {
                return {
    ...
    , It = ot('<svg><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">')
    , Mt = t=>{
        return ct(e = zt(), Y({
            get disabled() {
    ...
    , [Dt,Ft] = _()
    , Gt = ot("<span>Send")
    , Ht = ot('<div class="flex items-end justify-between chatbot-input" data-testid="input">')
    , Wt = t=>{
    ...
    , Yt = ot('<figure><img alt="Bot avatar" class="rounded-full object-cover w-full h-full">')
    , Xt = t=>{
            ...
            H(J, {
                ...
                get children() {
                    const t = Yt()
                        , r = t.firstChild;
                    return C((s=>{
                            var n = "flex justify-center items-center rounded-full text-white relative flex-shrink-0 " + (Dt() ? "w-6 h-6 text-sm" : "w-10 h-10 text-xl")
                                , o = e();
                            return n !== s._v$ && lt(t, s._v$ = n),
...
function re(t, e) {
    if (e) {
        if (Jt.test(t))
            return t.replace(Qt, (t=>Zt[t]))
    } else if (te.test(t))
        return t.replace(ee, (t=>Zt[t]));
    return t
}
function se(t) {
...
class oe {
    ...
    static getRulesBase() {
        ...
        return this.rulesBase || ((t = {
            ...
            _inside: /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/,
            _href: /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/
        }).link = new Kt(t.link).setGroup("inside", t._inside).setGroup("href", t._href).getRegexp(),
            t.reflink = new Kt(t.reflink).setGroup("inside", t._inside).getRegexp(),
            this.rulesBase = t)
    }
    ...
    static getRulesGfm() {
        ...
        return this.rulesGfm || (t = this.getRulesBase(),
            ...
            r = new Kt(t.text).setGroup("]|", "~]|").setGroup("|", "|https?://|").getRegexp(),
...
class ie {
    ...
    tok() {
        switch (this.token.type) {
            ...
            {
                let e = "";
                for (var t = this.token.ordered; this.next().type != kt.listEnd; )
                    e += this.tok();
            ...
            case kt.listItemStart:
            {
                ...
                for (; this.next().type != kt.listItemEnd; )
                    t += this.token.type == kt.text ? this.parseText() : this.tok();
            ...
            {
                let t = "";
                for (; this.next().type != kt.blockquoteEnd; )
                    t += this.tok();
...
class ae {
    ...
    static debug(t, e=this.options) {
        ...
        let s = t.slice();
        return (e = new ie(e)).simpleRenderers = this.simpleRenderers,
            e = e.debug(r, t),
            {
                tokens: s = s.map((t=>{
    ...
    static callParser(t, e, r) {
        var s;
        return this.simpleRenderers.length ? ((s = new ie(r)).simpleRenderers = this.simpleRenderers,
            s.parse(e, t)) : ie.parse(t, e, r)
    }
    static callMe(t) {
...
class le {
    ...
    static getRulesBase() {
        ...
        return this.rulesBase || ((t = {
            ...
            bullet: /(?:[*+-]|\d+\.)/,
            item: /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/
        }).item = new Kt(t.item,"gm").setGroup(/bull/g, t.bullet).getRegexp(),
            t.list = new Kt(t.list).setGroup(/bull/g, t.bullet).setGroup("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))").setGroup("def", "\\n+(?=" + t.def.source + ")").getRegexp(),
            ...
            t.html = new Kt(t.html).setGroup("comment", /<!--[\s\S]*?-->/).setGroup("closed", /<(tag)[\s\S]+?<\/\1>/).setGroup("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/).setGroup(/tag/g, e).getRegexp(),
            t.paragraph = new Kt(t.paragraph).setGroup("hr", t.hr).setGroup("heading", t.heading).setGroup("lheading", t.lheading).setGroup("blockquote", t.blockquote).setGroup("tag", "<" + e).setGroup("def", t.def).getRegexp(),
            this.rulesBase = t)
    }
    static getRulesGfm() {
        var t, e, r, s;
        return this.rulesGfm || (t = this.getRulesBase(),
            ...
            e.paragraph = new Kt(t.paragraph).setGroup("(?!", `(?!${r}|${s}|`).getRegexp(),
            this.rulesGfm = e)
    }
    ...
    getTokens(t, e, r) {
        ...
        t: for (; n; )
            ...
            1 < s[0].length) && this.tokens.push({
                ...
                n = n.substring(s[0].length),
                    this.tokens.push({
                        type: kt.blockquoteStart
                    }),
                    o = s[0].replace(/^ *> ?/gm, ""),
                    this.getTokens(o),
                    this.tokens.push({
                        type: kt.blockquoteEnd
                    });
                ...
                if (e && (s = this.rules.paragraph.exec(n)))
                    n = n.substring(s[0].length),
                        "\n" === s[1].slice(-1) ? this.tokens.push({
                            ...
                            type: 0 < this.tokens.length ? kt.paragraph : kt.text,
                            text: s[1]
                        });
...
le.simpleRules = [],
    ...
    le.rulesGfm = null,
    le.rulesTables = null;
const ce = ot('<div class="flex justify-end mb-2 items-end guest-container"><span class="px-4 py-2 mr-2 whitespace-pre-wrap max-w-full chatbot-guest-bubble" data-testid="guest-bubble">')
    , he = (ae.setOptions({
        isNoP: !0
    }),
        t=>{
            ...
            ));
            {
                ...
                return "function" == typeof e ? ht(e, s) : e = s,
    ...
    , ue = ot('<div class="flex justify-start mb-2 items-start host-container"><span class="px-4 py-2 ml-2 whitespace-pre-wrap max-w-full chatbot-host-bubble" data-testid="host-bubble">')
    , pe = (ae.setOptions({
        isNoP: !0
    }),
        t=>{
    ...
    , de = ot('<div class="flex items-center"><div class="w-2 h-2 mr-1 rounded-full bubble1"></div><div class="w-2 h-2 mr-1 rounded-full bubble2"></div><div class="w-2 h-2 rounded-full bubble3">')
    , fe = ()=>de()
    , ge = ot('<div class="flex justify-start mb-2 items-start animate-fade-in host-container"><span class="px-4 py-4 ml-2 whitespace-pre-wrap max-w-full chatbot-host-bubble" data-testid="host-bubble">')
    , be = ()=>{
    return ut((t = ge()).firstChild, H(fe, {})),
        t;
    var t
}
    , ye = ot('<div data-modal-target="defaultModal" data-modal-toggle="defaultModal" class="flex justify-start mb-2 items-start animate-fade-in host-container hover:brightness-90 active:brightness-75"><span class="px-2 py-1 ml-1 whitespace-pre-wrap max-w-full chatbot-host-bubble" data-testid="host-bubble">')
    , me = t=>{
    return r = (e = ye()).firstChild,
    ...
    , ve = (it(["click"]),
    ot('<span>Powered by<a href="https://flowiseai.com" target="_blank" rel="noopener noreferrer" class="lite-badge" id="lite-badge"><span> Flowise'))
    , we = "#303235"
    , xe = t=>{
    let e, r;
    const s = r=>{
    ...
    , Se = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === Object.prototype.toString.call(Blob)
    , Ae = "function" == typeof ArrayBuffer
    , Ee = ({type: t, data: e},r,s)=>Se && e instanceof Blob ? r ? s(e) : Oe(e, s) : Ae && (e instanceof ArrayBuffer || (t=>"function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(t) : t && t.buffer instanceof ArrayBuffer)(e)) ? r ? s(e) : Oe(new Blob([e]), s) : s(ke[t] + (e || ""))
    , Oe = (t,e)=>{
...
const Re = "function" == typeof ArrayBuffer
    ...
    , Le = (t,e)=>"blob" === e && t instanceof ArrayBuffer ? new Blob([t]) : t
...
const Me = ze.setTimeout
    , qe = ze.clearTimeout;
function De(t, e) {
    e.useNativeTimers ? (t.setTimeoutFn = Me.bind(ze),
        t.clearTimeoutFn = qe.bind(ze)) : (t.setTimeoutFn = ze.setTimeout.bind(ze),
...
class He extends Ne {
    ...
    onError(t, e, r) {
        return super.emitReserved("error", new Ge(t,e,r)),
            this
    }
    open() {
...
const We = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split("")
    , Ue = 64
    , Ve = {};
let Ye, Xe = 0, Ke = 0;
function Je(t) {
...
let tr = !1;
try {
    tr = "undefined" != typeof XMLHttpRequest && "withCredentials"in new XMLHttpRequest
} catch (n) {}
const er = tr;
function rr(t) {
    t = t.xdomain;
...
class or extends Ne {
    ...
    create() {
        var t = Ie(this.opts, "agent", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "autoUnref");
        ...
        "undefined" != typeof document && (this.index = or.requestsCount++,
    ...
    cleanup(t) {
        if (void 0 !== this.xhr && null !== this.xhr) {
            if (this.xhr.onreadystatechange = sr,
                t)
                try {
                    this.xhr.abort()
                } catch (t) {}
...
const ar = "function" == typeof Promise && "function" == typeof Promise.resolve ? t=>Promise.resolve().then(t) : (t,e)=>e(t, 0)
...
const hr = {
    websocket: class extends He {
        ...
        doOpen() {
            if (this.check()) {
                var t = this.uri()
                    ...
                    , r = cr ? {} : Ie(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
                this.opts.extraHeaders && (r.headers = this.opts.extraHeaders);
                try {
                    this.ws = cr ? new lr(t,e,r) : e ? new lr(t,e) : new lr(t)
                } catch (t) {
        ...
        uri() {
            ...
            let r = "";
            return this.opts.port && ("wss" == e && 443 !== Number(this.opts.port) || "ws" == e && 80 !== Number(this.opts.port)) && (r = ":" + this.opts.port),
            this.opts.timestampRequests && (t[this.opts.timestampParam] = Qe()),
            this.supportsBinary || (t.b64 = 1),
                t = Ze(t),
            e + "://" + (-1 !== this.opts.hostname.indexOf(":") ? "[" + this.opts.hostname + "]" : this.opts.hostname) + r + this.opts.path + (t.length ? "?" + t : "")
        }
        check() {
            return !!lr
        }
    ...
    polling: class extends He {
        ...
        uri() {
            ...
            let r = "";
            return !1 !== this.opts.timestampRequests && (t[this.opts.timestampParam] = Qe()),
            this.supportsBinary || t.sid || (t.b64 = 1),
            this.opts.port && ("https" == e && 443 !== Number(this.opts.port) || "http" == e && 80 !== Number(this.opts.port)) && (r = ":" + this.opts.port),
                t = Ze(t),
            e + "://" + (-1 !== this.opts.hostname.indexOf(":") ? "[" + this.opts.hostname + "]" : this.opts.hostname) + r + this.opts.path + (t.length ? "?" + t : "")
        }
        request(t={}) {
    ...
    , ur = /^(?:(?![^:@\/?#]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@\/?#]*)(?::([^:@\/?#]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/
        ...
        constructor(t, e={}) {
            ...
            t && "object" == typeof t && (e = t,
                ...
                t ? (t = dr(t),
                    ...
                    e.port = t.port,
                t.query && (e.query = t.query)) : e.host && (e.hostname = dr(e.host).host),
                De(this, e),
...
const gr = "function" == typeof ArrayBuffer
    , br = t=>"function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(t) : t.buffer instanceof ArrayBuffer
    , yr = Object.prototype.toString
    , mr = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === yr.call(Blob)
    , vr = "function" == typeof File || "undefined" != typeof File && "[object FileConstructor]" === yr.call(File);
function wr(t) {
    return gr && (t instanceof ArrayBuffer || br(t)) || mr && t instanceof Blob || vr && t instanceof File
}
function xr(t, e) {
...
function Sr(t, e) {
    if (t) {
        ...
        if (Array.isArray(t))
            ...
            for (const r in t)
                Object.prototype.hasOwnProperty.call(t, r) && (t[r] = Sr(t[r], e))
    }
    return t
}
...
class Or extends Ne {
    ...
    add(t) {
        ...
        if ("string" == typeof t) {
            ...
            (!r && e.type !== _t.BINARY_ACK || (e.type = r ? _t.EVENT : _t.ACK,
    ...
    static isPayloadValid(t, e) {
        switch (t) {
            ...
            case _t.BINARY_EVENT:
                return Array.isArray(e) && ("number" == typeof e[0] || "string" == typeof e[0] && -1 === Ar.indexOf(e[0]));
            case _t.ACK:
            case _t.BINARY_ACK:
...
class Pr {
    ...
    takeBinaryData(t) {
        return this.buffers.push(t),
            this.buffers.length === this.reconPack.attachments ? (t = Cr(this.reconPack, this.buffers),
...
var $r = Object.freeze({
    ...
    Encoder: class {
        ...
        encode(t) {
            return t.type !== _t.EVENT && t.type !== _t.ACK || !xr(t) ? [this.encodeAsString(t)] : this.encodeAsBinary({
                type: t.type === _t.EVENT ? _t.BINARY_EVENT : _t.BINARY_ACK,
                nsp: t.nsp,
                data: t.data,
                id: t.id
            })
        ...
        encodeAsString(t) {
            let e = "" + t.type;
            return t.type !== _t.BINARY_EVENT && t.type !== _t.BINARY_ACK || (e += t.attachments + "-"),
            t.nsp && "/" !== t.nsp && (e += t.nsp + ","),
            null != t.id && (e += t.id),
...
class Br extends Ne {
    ...
    subEvents() {
        var t;
        this.subs || (t = this.io,
            this.subs = [Rr(t, "open", this.onopen.bind(this)), Rr(t, "packet", this.onpacket.bind(this)), Rr(t, "error", this.onerror.bind(this)), Rr(t, "close", this.onclose.bind(this))])
    }
    get active() {
        return !!this.subs
    }
...
class jr extends Ne {
        ...
        if (!~this._readyState.indexOf("open")) {
            ...
            if (!1 !== this._timeout) {
                ...
                const t = this.setTimeoutFn((()=>{
                        o(),
                            s.close(),
                            s.emit("error", new Error("timeout"))
                    }
                ), r);
    ...
    socket(t, e) {
        let r = this.nsps[t];
        return r ? this._autoConnect && !r.active && r.connect() : (r = new Br(this,t,e),
            this.nsps[t] = r),
            r
    }
    _destroy(t) {
...
function zr(t, e) {
    ...
    let o;
    return o = (n = e.forceNew || e["force new connection"] || !1 === e.multiplex || n) ? new jr(r,e) : (Nr[s] || (Nr[s] = new jr(r,e)),
        Nr[s]),
...
const Dr = t=>{
    ...
    , Fr = ot('<div><div class="flex w-full h-full justify-center"><div class="overflow-y-scroll min-w-full w-full min-h-full px-3 pt-10 relative scrollable-container chatbot-chat-view scroll-smooth">')
    , Gr = ot("<div>")
    ...
    const [n,o] = _("")
        ...
        "" !== e.trim()) {
            ...
            i && ("object" == typeof i && i.text && i.sourceDocuments ? b() || d((t=>[...t, {
                ...
                m()),
            l && (console.error(l),
                s = l.response.data || l.response.status + ": " + l.response.statusText,
                r = s,
                d((t=>[...t, {
                    message: r,
                    type: "apiMessage"
        ...
        , k = (S((()=>{
            ...
            S((async()=>{
                    var e = (await (({chatflowid: t, apiHost: e="http://localhost:3000"})=>Et({
                        method: "GET",
    ...
    return [(()=>{
            const o = Fr()
                ...
                , l = a.firstChild;
            var h;
            return "function" == typeof (h = ("function" == typeof (h = s) ? ht(h, o) : s = o,
                e)) ? ht(h, l) : e = l,
                ...
                ut(l, H(K, {
                    ...
                    children: (e,r)=>[A((()=>{
                            ...
                            const t = A((()=>!("userMessage" !== e.type || !i() || r() !== p().length - 1)));
                            return ()=>t() && H(be, {})
                        }
                    )()), A((()=>{
                            const t = A((()=>!(!e.sourceDocuments || !e.sourceDocuments.length)));
                            return ()=>{
                                return t() && ((r = Gr()).style.setProperty("display", "flex"),
                                        ...
                                        get each() {
                                            return [...(t=>{
                                                    ...
                                                    return t.sourceDocuments.forEach((t=>{
                                                            k(t.metadata.source) && !e.includes(t.metadata.source) ? (e.push(t.metadata.source),
                                                                r.push(t)) : k(t.metadata.source) || r.push(t)
                                                        }
                                                    )),
                                                        r
                                                }
                ...
                C((()=>lt(o, "relative flex w-full h-full text-base overflow-hidden bg-cover bg-center flex-col items-center chatbot-container " + t.class))),
                o
        }
    )(), A((()=>{
            const t = A((()=>!!l()));
    ...
    , rs = ("undefined" != typeof window && (wt("flowise-fullchatbot", xt, Zr),
    wt("flowise-chatbot", xt, Kr)),
    {
        initFull: ts,
        init: es
    });
